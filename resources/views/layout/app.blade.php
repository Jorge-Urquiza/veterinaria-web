        ...
        <!-- Nav Item - Pages Collapse Menu -->
	        <li class="nav-item">
	                <a class="nav-link collapsed" href="#"><i class="fas fa-fw fa-cog"></i>
	                    <span>CU1 Gestionar Clientes</span></a>
	        </li>
       
            <li class="nav-item">
                <a class="nav-link collapsed" href="#"><i class="fas fa-fw fa-cog"></i>
                    <span>CU2 Gestionar Mascotas</span></a>
            </li>
     
       
            <li class="nav-item">
            <a class="nav-link collapsed" href="{{route('veterinarios')}}"><i class="fas fa-fw fa-cog"></i>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href=""><i class="fas fa-fw fa-cog"></i>
                    <span>CU4 Gestionar Categorias</span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href=""><i class="fas fa-fw fa-cog"></i>
                    <span>CU5 Gestionar Productos</span></a>
            </li>
     
       
            <li class="nav-item">
                <a class="nav-link collapsed" href=""><i class="fas fa-fw fa-cog"></i>
                    <span>CU6 Gestionar Ventas</span></a>
            </li>
     
       
            <li class="nav-item">
                <a class="nav-link collapsed" href=""><i class="fas fa-fw fa-cog"></i>
                    <span>CU7 Gestionar Atencion</span></a>
            </li>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Veterinaria Animal Help 2020</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
