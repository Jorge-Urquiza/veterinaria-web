          ...
          @method('PUT')
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              {!! Form::select('genero', ['Masculino'=>'Masculino','Femenino'=>'Femenino', 'Otro' => 'Otro'], null, 
               ['class' => 'form-control form-control-sm ' . ( $errors->has('genero') ? ' is-invalid' : '' ),
              'id' =>'genero' ]) !!}
              {!! $errors->first('tipo_control','<span class="invalid-feedback d-block">:message</span>') !!}
